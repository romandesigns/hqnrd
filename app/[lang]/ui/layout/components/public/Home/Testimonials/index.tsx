...
export default function Testimonials() {
  return (
    <Section className="w-full bg-primary-100/30 py-10 px-2 rounded-md sm:px-10">
      <article className="w-full h-full bg-primary-100/40 py-10 p-2 rounded-md sm:px-4 relative">
        <div>
        ...
        <div className="bg-[url('/assets/general/quotes-icon.svg')] bg-no-repeat bg-[right_-5rem_bottom_-2rem]  absolute top-0 left-0 right-0 bottom-0 z-0 opacity-10" />
      </article>
    </Section>
  );
}
