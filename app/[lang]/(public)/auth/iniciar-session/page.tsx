...
export default function Page({
  ...
  return (
    <main className="w-full min-h-dvh flex items-items justify-center">
      <section className="h-inherit w-full flex items-center justify-center relative p-2 px-4 bg-red-500">
        <div className="flex w-full h-[47rem] p-2 sm:w-4/5 md:w-3/5 lg:w-4/5 lg:max-w-5xl relative z-[2] bg-white rounded-md gap-4">
          ...
          <article className="h-full grid grid-cols-1 grid-rows-[auto_1fr] flex-1 rounded-md p-4 bg-white border">
            ...
            <div className="place-self-center w-11/12 sm:w-8/12 md:w-10/12">
              ...
              <SignInForm lang={lang} locale={locale as Country} />
              <div className="mt-8">
