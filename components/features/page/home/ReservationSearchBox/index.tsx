...
export function ReservationSearchBox({ lang }: { lang: Locale }) {
  return (
    <Content className="max-w-5xl rounded-lg bg-primary-foreground p-5 shadow-2xl">
      <article className="grid h-full w-full grid-cols-[1fr_1fr_1fr_1fr_10rem] grid-rows-1 items-center justify-center gap-5 rounded-lg p-5">
        <InputNumber
          name="adultsCount"
